...
var intasend = new IntaSend('ISPubKey_test_91ffc81a-8ac4-419e-8008-7091caa8d73f', 'ISSecretKey_test_15515fe9-fb5d-4362-970e-625532df8181', true);
// Create checkout page i.e payment collection link
var collection = intasend.collection();
collection
    .charge({
    first_name: 'FELIX',
    last_name: 'Cheruiyot',
    ...
    .then(function (resp) {
    console.log("Charge Resp: ".concat(JSON.stringify(resp)));
})
    .catch(function (err) {
    console.log("Charge error: ".concat(err));
});
...
collection
    ...
    .then(function (resp) {
    console.log("Resp: ".concat(JSON.stringify(resp)));
})
    .catch(function (err) {
    console.error("error: ".concat(err));
});
// How to create and interact with Wallets
var wallets = intasend.wallets();
wallets
    .create({
    ...
    .then(function (resp) {
    console.log("Funding response: ".concat(JSON.stringify(resp)));
})
    .catch(function (err) {
...
payouts
    ...
    .then(function (resp) {
    console.log("Payouts response: ".concat(JSON.stringify(resp)));
    // Approve payouts
    // if (req_approval === 'YES'){
    //   payouts
    //     .approve(resp)
    ...
    .catch(function (err) {
    console.error("Payouts error: ".concat(err));
});
// How to handle refunds
var refunds = intasend.refunds();
refunds
    .create({
    ...
    .then(function (resp) {
    console.log("Invoice response: ".concat(resp));
})
    .catch(function (err) {
    console.error("Invoice error: ".concat(err));
});
